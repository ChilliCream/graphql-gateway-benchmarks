...
| :------ | :-------- | :------ | ---------: | -------: | --------: | --: | :---- |
| hive-router | rust | v0.0.41 | 2,764 | 2,969 | 2,736 | 2.8% |  |
| hive-router | .net | v0.0.41 | 2,280 | 2,418 | 2,236 | 2.5% |  |
| grafbase | rust | 0.53.2 | 2,107 | 2,165 | 2,087 | 1.2% |  |
| hotchocolate | rust | 16.0.0-p.11.46 | 1,856 | 1,907 | 1,839 | 1.0% |  |
| hotchocolate | .net | 16.0.0-p.11.46 | 1,676 | 1,710 | 1,633 | 1.6% |  |
| grafbase | .net | 0.53.2 | 1,524 | 1,557 | 1,511 | 1.0% |  |
| cosmo | rust | 0.291.0 | 1,284 | 1,304 | 1,275 | 0.7% | non-compatible response (5 across 4/10 runs) |
| cosmo | .net | 0.291.0 | 1,185 | 1,212 | 1,174 | 1.0% | non-compatible response (2 across 2/10 runs) |
| hive-gateway-router-runtime | rust | 2.5.6 | 533 | 547 | 529 | 1.2% |  |
| hive-gateway-router-runtime | .net | 2.5.6 | 498 | 513 | 492 | 1.4% |  |
| apollo-router | rust | v2.12.0 | 433 | 442 | 428 | 1.0% |  |
| apollo-router | .net | v2.12.0 | 371 | 382 | 365 | 1.5% | non-compatible response (1 across 1/10 runs) |
| hive-gateway | rust | 2.5.6 | 263 | 268 | 260 | 1.1% |  |
| hive-gateway | .net | 2.5.6 | 257 | 261 | 254 | 1.0% |  |
| apollo-gateway | .net | 2.13.2 | 241 | 246 | 240 | 0.8% |  |
| apollo-gateway | rust | 2.13.2 | 240 | 243 | 238 | 0.9% |  |
